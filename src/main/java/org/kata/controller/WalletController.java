...
public class WalletController {
    ...
    public ResponseEntity<List<WalletDto>> getWallet(
        ...
        return new ResponseEntity<>(walletService.getWallets(icp, conversationId), HttpStatus.OK);
    }
    ...
    public ResponseEntity<BigDecimal> getTotalBalance(
        ...
        return new ResponseEntity<>(walletService.getTotalBalance(icp, currencyType, conversationId), HttpStatus.OK);
    }
}